            ...
            {/* <div className="container eduvibe-animated-shape">
                    ...
                    <div className="col-lg-6">
                        <div className="view-more-btn text-end">
                            <Link className="edu-btn" to="/course-1">
                                View All Courses <i className="icon-arrow-right-line-right"></i>
                            </Link>
                        </div>
                    </div>
                </div>
                ...
                <div className="shape-dot-wrapper shape-wrapper d-xl-block d-none">
                    <div className="shape-image shape-image-1">
                        <img src="/images/shapes/shape-13-10.png" alt="Shape" />
                    </div>
                    <div className="shape-image shape-image-2">
                        <img src="/images/shapes/shape-04-03.png" alt="Shape" />
                    </div>
                    <div className="shape-image shape-image-3">
                        <img src="/images/shapes/shape-15-03.png" alt="Shape" />
                    </div>
